...
public class MailDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		// ts.connect("smtp.163.com", "beibei1142617253", "ouyang1985424");
	...
	public static MimeMessage createSimpleMail(Session session) throws Exception {
		...
		// 指明邮件的发件人
		message.setFrom(new InternetAddress("beibei1142617253@163.com"));

		// 指明邮件的收件人，现在发件人和收件人是一样的，那就是自己给自己发
		message.setRecipient(Message.RecipientType.TO, new InternetAddress("beibei1142617253@163.com"));
